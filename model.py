...
class get_dunet_model():
    ...
    def encoder_layer(self, x):
        p = Activation('relu')(x)
        c = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(p)
        c1 = Conv2D(32, (3, 3), kernel_initializer='he_normal', padding='same')(c)
        c1 += p
        p1 = MaxPooling2D((2, 2))(c1)
    ...
    def decoder_layer(self, x, concat, add = None):
        ...
        c = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(u)
        c = Conv2D(32, (2, 2), kernel_initializer='he_normal', padding='same')(c)
    ...
    def build(self):
        ...
        c = Conv2D(64, (3, 3), kernel_initializer='he_normal', padding='same')(s)
        c = Activation('relu')(c)
        c = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c)
        c0 = Conv2D(32, (2, 2), kernel_initializer='he_normal', padding='same')(c)
...
class get_aunet_model():
    def __init__ (self, n_classes=4, IMG_HEIGHT=256, IMG_WIDTH=256, IMG_CHANNELS=1):
        ...
        self.IMG_WIDTH = IMG_WIDTH
        self.IMG_CHANNELS = IMG_CHANNELS
        self.W_g5 = Conv2D(16*4, 1, padding='same', use_bias=True)
        self.W_x5 = Conv2D(16*4, 1, padding='same', use_bias=False)
        self.psi5 = Conv2D(1, 1, activation='sigmoid', padding='same')
        self.W_g6 = Conv2D(16*2, 1, padding='same', use_bias=True)
        self.W_x6 = Conv2D(16*2, 1, padding='same', use_bias=False)
        self.psi6 = Conv2D(1, 1, activation='sigmoid', padding='same')
        self.W_g7 = Conv2D(16, 1, padding='same', use_bias=True)
        self.W_x7 = Conv2D(16, 1, padding='same', use_bias=False)
    ...
    def build(self):
        ...
        x = Conv2D(16, 3, activation='relu', padding='same')(s)
        x1 = Conv2D(16, 3, activation='relu', padding='same')(x)
        x = MaxPooling2D(pool_size=(2,2))(x1)

        x = Conv2D(16*2, 3, activation='relu', padding='same')(x)
        x2= Conv2D(16*2, 3, activation='relu', padding='same')(x)
        x = MaxPooling2D(pool_size=(2,2))(x2)

        x = Conv2D(16*4, 3, activation='relu', padding='same')(x)
        x3 = Conv2D(16*4, 3, activation='relu', padding='same')(x)
        x = MaxPooling2D(pool_size=(2,2))(x3)

        x = Conv2D(16*8, 3, activation='relu', padding='same')(x)
        x = Conv2D(16*8, 3, activation='relu', padding='same')(x)
